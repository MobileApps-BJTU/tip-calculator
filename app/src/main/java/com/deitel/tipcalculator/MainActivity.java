...
public class MainActivity extends Activity
{
    ...
    private int partySize = 1;//number of people entered by the user
    private TextView partySizeTextView;//shows number of people
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        partySizeTextView=
                (TextView) findViewById(R.id.partySizeTextView);
        ...
        percentCustomTextView.setText(
                currencyFormat.format(partySize));
        updateStandard(); // update the 15% tip TextViews
        updateCustom(); // update the custom tip TextViews
    ...
    private TextWatcher partySizeEditTextWatcher = new TextWatcher()
    {
                                  ...
                                  int before, int count)
        {
            ...
            // display currency formatted bill amount
            partySizeTextView.setText(currencyFormat.format(partySize));
            updateStandard(); // update the 15% tip TextViews
            updateCustom(); // update the custom tip TextViews
        } // end method onTextChanged
