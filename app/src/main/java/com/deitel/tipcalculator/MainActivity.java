...
public class MainActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        numberDisplayTextView.setText(numberInParty+"");
    ...
    private void updateStandard()
    {
        ...
        double fifteenPercentTotal = billAmount/numberInParty * (1+0.15);
    ...
    private void updateCustom()
    {
        ...
        double customTotal = billAmount/numberInParty * (1+customPercent);
