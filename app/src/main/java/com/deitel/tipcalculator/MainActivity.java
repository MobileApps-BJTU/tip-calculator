...
public class MainActivity extends Activity
{
    ...
    private static final NumberFormat personFormat =
    ...
    //Add by christy Luo
    private int personNum = 0; //person number entered by the user,I made it 0 first
    private TextView personNumDisplayTextView;//shows the person number
    private TextView per15TextView; //show per amount with 15% tip
    private TextView perCustomTextView; //show per amount with custom tip
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //Add by christy Luo
        personNumDisplayTextView = (TextView)findViewById(R.id.personNumDisplayTextView);
        per15TextView = (TextView)findViewById(R.id.per15TextView);
        perCustomTextView = (TextView)findViewById(R.id.perCustomTextView);
        ...
        //Add by Christy Luo
        personNumDisplayTextView.setText(Integer.toString(personNum));
        ...
        //Add by Christy Luo
        EditText peopleEditText = (EditText) findViewById(R.id.peopleEditText);
    ...
    private void updateStandard()
    {
        ...
        double fifteenPercentPer = 0.0;
        if (personNum > 0)
        {
            fifteenPercentPer = fifteenPercentTotal / personNum;
        }

        // display 15% tip and total formatted as currency
        tip15TextView.setText(currencyFormat.format(fifteenPercentTip));
        total15TextView.setText(currencyFormat.format(fifteenPercentTotal));
        per15TextView.setText(currencyFormat.format(fifteenPercentPer));
    ...
    private void updateCustom()
    {
        ...
        double customPer = 0.0;
        if (personNum > 0)
        {
            customPer = customTotal / personNum;
        }
        // display custom tip and total formatted as currency
        tipCustomTextView.setText(currencyFormat.format(customTip));
        totalCustomTextView.setText(currencyFormat.format(customTotal));
        perCustomTextView.setText(currencyFormat.format(customPer));
    ...
    private TextWatcher peopleEditTextWatcher = new TextWatcher()
    {
                                  ...
                                  int before, int count)
        {
            ...
            try
            {
                ...
                //Double.parseDouble(s.toString()) / 100.0;
            } // end try
            catch (NumberFormatException e)
            {
            ...
            // display currency formatted person number
            personNumDisplayTextView.setText(Integer.toString(personNum));
            updateStandard(); // update the 15% tip TextViews
            updateCustom(); // update the custom tip TextViews
        } // end method onTextChanged
