...
public class MainActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        final Button transferButton = (Button) findViewById(R.id.transferButton);
    ...
    private void updateStandard()
    {
        ...
        double fifteenPercentAverage = fifteenPercentTip/number;
    ...
    private void updateCustom()
    {
        ...
        double customPercentAverage = customTip/number;

        // display custom tip and total formatted as currency
        tipCustomTextView.setText(currencyFormat.format(customTip));
        totalCustomTextView.setText(currencyFormat.format(customTotal));
        averageCustomTextView.setText(currencyFormat.format(customPercentAverage));
    ...
    private TextWatcher numberEditTextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start,
            ...
            // convert amountEditText's text to a double
            try {
                number = Double.parseDouble(s.toString());//I am confused about the rule of transfer when set variable "number" as type "int",set it as "double" temporarily
            } // end try
            catch (NumberFormatException e) {
                number = 0.0; // default if an exception occurs
            } // end catch
