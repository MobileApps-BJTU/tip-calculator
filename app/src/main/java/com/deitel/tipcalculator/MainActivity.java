...
public class MainActivity extends Activity
{
    ...
    private int peopleNumber=1;// people number
    ...
    private TextView numberDisplayTextView; // shows the number of people
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        numberDisplayTextView.setText(peopleNumber+"");
    ...
    private void updateStandard()
    {
        ...
        if(peopleNumber>0) {
            ...
            double fifteenPercentTotal = (billAmount + fifteenPercentTip) / peopleNumber;
    ...
    private void updateCustom()
    {
        ...
        if(peopleNumber>0) {
            ...
            double customTotal = (billAmount + customTip) / peopleNumber;
    ...
    private TextWatcher numberEditTextWatcher = new TextWatcher()
    {
                                  ...
                                  int before, int count)
        {
            ...
            {
                peopleNumber = 1; // default if an exception occurs
            } // end catch
