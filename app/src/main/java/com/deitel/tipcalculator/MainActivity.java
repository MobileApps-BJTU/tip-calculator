...
public class MainActivity extends Activity
{
    ...
    private TextView numberPeopleDisplayTextView;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        numberPeopleDisplayTextView = (TextView) findViewById(R.id.numberPeopleDisplayTextView);

        // update GUI based on billAmount and customPercent
        amountDisplayTextView.setText( currencyFormat.format(billAmount));
        numberPeopleDisplayTextView.setText(numberPeople+"");
        ...
        //set numberPeopleText's TextWatcher
        EditText numberPeopleEditText =
                (EditText) findViewById(R.id.numberPeopleEditText);
        numberPeopleEditText.addTextChangedListener(numberPeopleEditTextWatcher);
    ...
    private void updateStandard()
    {
        ...
        double fifteenPercentTotal = (billAmount + fifteenPercentTip)/numberPeople;
    ...
    private void updateCustom()
    {
        ...
        double customTotal = (billAmount + customTip)/numberPeople;
    ...
    // event-handling object that responds to numberPeopleEditText's events
    private TextWatcher numberPeopleEditTextWatcher  = new TextWatcher()
    {
        // called when the user enters a number
        @Override
        public void onTextChanged(CharSequence s, int start,
                                  int before, int count)
        {
            ...
            try
            {
                numberPeople = Integer.parseInt(s.toString());
            } // end try
            catch (NumberFormatException e)
            {
                numberPeople = 1; // default if an exception occurs
            } // end catch
