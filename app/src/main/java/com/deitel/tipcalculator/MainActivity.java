...
public class MainActivity extends Activity 
{
   ...
   private int personNumInParty = 1; // initial person number in party
   ...
   private TextView numberInPartyTextView; // shows person number in party
   ...
   protected void onCreate(Bundle savedInstanceState)
   {
      ...
      numberInPartyTextView =
         (TextView) findViewById(R.id.numberInPartyTextView);
   ...
   private void updateStandard() 
   {
      ...
      double fifteenPercentTotal = (billAmount + fifteenPercentTip)/personNumInParty;
   ...
   private void updateCustom() 
   {
      ...
      double customTotal = (billAmount + customTip)/personNumInParty;
   ...
   private TextWatcher numberEditTextWatcher = new TextWatcher() {
                                 ...
                                 int before, int count)
       {
           ...
           try
           {
               personNumInParty = Integer.parseInt(s.toString());
           } // end try
           catch (NumberFormatException e)
           {
               personNumInParty = 1; // default if an exception occurs
           } // end catch

           // display currency formatted bill amount
           numberInPartyTextView.setText(String.valueOf(personNumInParty));
           updateStandard(); // update the 15% tip TextViews
           updateCustom(); // update the custom tip TextViews
