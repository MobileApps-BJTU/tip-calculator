...
public class MainActivity extends Activity
{
    ...
    private Integer number = 0;  // number of people entered by the user
    ...
    private void updateStandard()
    {
        ...
        double fifteenPercentTotalPerPerson = 0.0;

        if(number > 1)
            fifteenPercentTotalPerPerson = fifteenPercentTotal / (number * 1.0);
        else
            fifteenPercentTotalPerPerson = fifteenPercentTotal;
    ...
    private void updateCustom()
    {
        ...
        double customTotalPerPerson = 0.0;
        if(number > 1)
            customTotalPerPerson = customTotal / (number * 1.0);
        else
            customTotalPerPerson = customTotal;
    ...
    private TextWatcher numberEditTextWatcher = new TextWatcher()
    {
        ...
        public void onTextChanged(CharSequence s, int start,
                                  int before, int count)
        {
            // convert numberEditText's text to an integer
            try
            {
            ...
            updateStandard(); // update the 15% tip TextViws
            updateCustom(); // update the custom tip TextViews
        } // end method onTextChanged
