...
public class MainActivity extends Activity {
    ...
    private TextView totalPerPerson15TextView; // shows total per person with 15% tip
    private TextView tipCustomTextView; // shows custom tip amount
    private TextView totalPerPersonCustomTextView; // shows total per person with custom tip
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalPerPersonCustomTextView =
                (TextView) findViewById(R.id.totalPerPersonCustomTextView);
    ...
    private void updateStandard() {
        ...
        totalPerPerson15TextView.setText(currencyFormat.format(fifteenPercentTotalPerPerson));
    ...
    private void updateCustom() {
        ...
        totalPerPersonCustomTextView.setText(currencyFormat.format(customTotalPerPerson));
