...
public class MainActivity extends Activity 
{
   ...
   private int numberOfPeople = 1; // the number of people
   ...
   private void updateStandard() 
   {
      ...
      double fifteenPercentTotal = (billAmount + fifteenPercentTip) / numberOfPeople;
   ...
   private void updateCustom() 
   {
      ...
      double customTotal = (billAmount + customTip)  / numberOfPeople;
   ...
   private TextWatcher numberEditTextWatcher = new TextWatcher()
   {
       ...
       public void onTextChanged(CharSequence s, int start,
                                  int before, int count)
       {
           // convert numberEditText's text to an int
           try{
