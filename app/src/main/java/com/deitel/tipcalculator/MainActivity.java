...
public class MainActivity extends Activity
{
    ...
    // private
    private TextView each15TextView;
    private TextView eachCustomTextView;
    private EditText numOfCustomer;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        numOfCustomer= (EditText)findViewById(R.id.numEditText);
        ...
        numOfCustomer.addTextChangedListener(numEditTextWatcher);
    ...
    private void updateStandard()
    {
        ...
        double eachtip =fifteenPercentTotal/customerNum;
        each15TextView.setText(currencyFormat.format(eachtip));
    ...
    private void updateCustom()
    {
        ...
        double eachCustom=customTotal/customerNum;
        eachCustomTextView.setText(currencyFormat.format(eachCustom));
    ...
    //new add
    private TextWatcher numEditTextWatcher = new TextWatcher()
    {
        // called when the user enters a number
        @Override
        public void onTextChanged(CharSequence s, int start,
                                  int before, int count)
        {
            ...
            try
            {
                customerNum = (int) (Double.parseDouble(s.toString()));

            } // end try
            catch (NumberFormatException e)
            {
                customerNum = 0; // default if an exception occurs
            } // end catch

            if(customerNum==0){
                Toast.makeText(getApplicationContext(), "The num of people can't be zero!",
