...
public class MainActivity extends Activity
{
    ...
    private int totalPeopleNumber=2;//initial number of people
    ...
    private EditText totalPeople; //show total people
    private TextView totalBill; //the total bill
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        totalPeople.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                ...
                try
                {
                    totalPeopleNumber = Integer.parseInt(charSequence.toString());
                    if(totalPeopleNumber<=1)
                    {
                        Toast.makeText(getBaseContext(), "the number should be more than one", Toast.LENGTH_SHORT).show();
                        totalPeople.setText("2");
                        return;
                    }
                ...
                {
                    totalPeopleNumber = 2; // default if an exception occurs
                }
                // end catch
            }
    ...
    private void updateStandard()
    {
        ...
        double perBill=fifteenPercentTotal/totalPeopleNumber;

        // display 15% tip and total formatted as currency
        tip15TextView.setText(currencyFormat.format(fifteenPercentTip));
        total15TextView.setText(currencyFormat.format(perBill));
    ...
    private void updateCustom()
    {
        ...
        double perBill=customTotal/totalPeopleNumber;
        // display custom tip and total formatted as currency
        totalBill.setText(currencyFormat.format(customTotal));
        tipCustomTextView.setText(currencyFormat.format(customTip));
        totalCustomTextView.setText(currencyFormat.format(perBill));
