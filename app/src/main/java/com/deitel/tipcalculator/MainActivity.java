...
public class MainActivity extends Activity
{
    ...
    //private TextView personNumTextView;   // shows the number of people
    private TextView perPerson15TextView;    // shows total per person with 15% tip
    private TextView perPersonCustomTextView;   // shows total per person with custom tip
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //personNumTextView = (TextView) findViewById(R.id.personNumTextView);
        perPerson15TextView = (TextView) findViewById(R.id.perPerson15TextView);
        perPersonCustomTextView = (TextView) findViewById(R.id.perPersonCustomTextView);
        ...
        // set personNumEditText's TextWatcher
        personNumEditText = (EditText) findViewById(R.id.personNumEditText);
        personNumEditText.setText(String.valueOf(personNum));
        personNumEditText.addTextChangedListener(personNumEditTextWatcher);
    ...
    private void updateStandard()
    {
        ...
        double fifteenPerPerson ;

        // display 15% tip and total formatted as currency
        tip15TextView.setText(currencyFormat.format(fifteenPercentTip));
        total15TextView.setText(currencyFormat.format(fifteenPercentTotal));

        fifteenPerPerson = fifteenPercentTotal / personNum;
        perPerson15TextView.setText(currencyFormat.format(fifteenPerPerson));
    ...
    private void updateCustom()
    {
        ...
        double customPerPerson ;

        // display custom tip and total formatted as currency
        tipCustomTextView.setText(currencyFormat.format(customTip));
        totalCustomTextView.setText(currencyFormat.format(customTotal));

        customPerPerson = customTotal / personNum;
        perPersonCustomTextView.setText(currencyFormat.format(customPerPerson));
    ...
    private TextWatcher personNumEditTextWatcher = new TextWatcher() {
        @Override
        ...
        public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            //Log.v("Test",charSequence.toString());
            if(!charSequence.toString().equals("")){
                if(charSequence.toString().equals("0")){
                    personNumEditText.setError("0 is Invalid.");
                    personNum = 1;
                    personNumEditText.setText(String.valueOf(personNum));
                    updateStandard();
                    updateCustom();
                }else{
                    personNum = Integer.parseInt(personNumEditText.getText().toString());
                    updateStandard();
                    updateCustom();
                }
            }else{
