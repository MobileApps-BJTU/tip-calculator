...
/**
 * Upload Assignment: Exercise 3.5 Enhanced Tip Calculator App  
 * @author 12301052 杨光(Guang Yang)
 */
...
public class MainActivity extends Activity {
    ...
    private double numberOfPeoele = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set hint
        number.setHint(R.string.please_input_a_nmber);
        //there only a line
        ...
        number.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                try{
                    numberOfPeoele = Double.valueOf(s.toString());
                    if(numberOfPeoele <= 0){
    ...
    private void updateStandard() {
        ...
        total15TextView.setText(currencyFormat.format(fifteenPercentTotal/numberOfPeoele));
    ...
    private void updateCustom() {
        ...
        totalCustomTextView.setText(currencyFormat.format(customTotal/numberOfPeoele));
