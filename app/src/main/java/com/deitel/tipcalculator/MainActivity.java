...
public class MainActivity extends Activity
{
    ...
    private TextView personNumberDisplayTextView; //show the number in party
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        personNumberDisplayTextView =
                (TextView)findViewById(R.id.personNumberDisplayTextView);
        ...
        personNumberDisplayTextView.setText(personNumber.toString());
        ...
        // set personNumberEditText's TextWatcher
        EditText personNumberEditText =
                (EditText)findViewById(R.id.personNumberEditText);
        personNumberEditText.addTextChangedListener(personNumberEditTextWatcher);
    ...
    private void updateStandard()
    {
        ...
        double fifteenPercentTotal = (billAmount + fifteenPercentTip)/personNumber;
    ...
    private void updateCustom()
    {
        ...
        double customTotal = (billAmount + customTip)/personNumber;
    ...
    private TextWatcher personNumberEditTextWatcher = new TextWatcher() {
        @Override
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            try {
                personNumber = Integer.parseInt(s.toString());
            }
            catch (NumberFormatException e)
            {
                personNumber = 1; // default if an exception occurs
            }
    ...
    }; // end personNumberEditTextWatcher
