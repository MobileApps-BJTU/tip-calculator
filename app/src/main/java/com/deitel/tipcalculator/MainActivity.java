...
public class MainActivity extends Activity
{
    ...
    private int peopleAmount = 0; //people amount entered by the user
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        EditText peopleNumberEditText =
                (EditText)findViewById(R.id.peopleNumberEditText);
        //add text change listener of peopleNumberEditText
        peopleNumberEditText.addTextChangedListener(amountEditTextWatcher2);
    ...
    private void updateStandard()
    {
        ...
        double fifteenPercentTotal = (billAmount + fifteenPercentTip)/peopleAmount;
    ...
    private void updateCustom()
    {
        ...
        double customTotal = (billAmount + customTip)/peopleAmount;
    ...
    private TextWatcher amountEditTextWatcher2 = new TextWatcher()
    {
        // called when the user enters a number
        @Override
        public void onTextChanged(CharSequence s, int start,
                                  int before, int count)
        {
            ...
            {
                peopleAmount=0; // default if an exception occurs
            } // end catch

            // display currency formatted bill amount
            // numberInP.setText(String.valueOf(numberOfp));
            updateStandard(); // update the 15% tip TextViews
            updateCustom(); // update the custom tip TextViews
        } // end method onTextChanged
