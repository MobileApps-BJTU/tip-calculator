...
public class MainActivity extends Activity
{
    ...
    private double billAmount = 0.0; // bill amount entered by the userpriv
    private int number= 2;
    private EditText peoplenumberText;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        peoplenumberText = (EditText) findViewById(R.id.peoplenumberText);
        ...
        peoplenumberText.addTextChangedListener(new TextWatcher() {
            @Override
