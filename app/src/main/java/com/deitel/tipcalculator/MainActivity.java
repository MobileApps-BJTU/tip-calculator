...
public class MainActivity extends Activity 
{
   ...
   private int num = 1; //number in party entered by the user
   ...
   private TextView numberDisplayTextView; //shows number of people in the party
   ...
   protected void onCreate(Bundle savedInstanceState)
   {
      ...
      // update GUI based on billAmount, number of person and customPercent
      amountDisplayTextView.setText(
         currencyFormat.format(billAmount));
      numberDisplayTextView.setText(String.valueOf(num));
   ...
   private void updateStandard() 
   {
      ...
      fifteenPercentTotal = fifteenPercentTotal/num;
   ...
   private void updateCustom() 
   {
      ...
      //calculate the total custom tip by person
      customTotal = customTotal/ num;
   ...
   private TextWatcher amountEditTextWatcher = new TextWatcher() 
   {
    ...
    private TextWatcher numberEditTextWatcher = new TextWatcher()
    {
                                  ...
                                  int before, int count)
        {
            ...
            {
                num = 1; // default if an exception occurs
            } // end catch
