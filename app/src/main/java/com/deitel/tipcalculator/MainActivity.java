...
public class MainActivity extends Activity
{
    ...
    private int numberInParty = 1;   //number of peoples
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        peopleEditText.addTextChangedListener(numberInPartyEditTextWatcher);
    ...
    private void updateStandard()
    {
        ...
        total15TextView.setText(currencyFormat.format(fifteenPercentTotal/numberInParty));
    ...
    private void updateCustom()
    {
        ...
        //average bill
        totalCustomTextView.setText(currencyFormat.format(customTotal/numberInParty));
    ...
    // event-handling object that responds to numberInPartyEditText's events
...
// amountDisplayTextView.setText(currencyFormat.format(billAmount));
    ...
    }; // end numberInPartyEditTextWatcher
