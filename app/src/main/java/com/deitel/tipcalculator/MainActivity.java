...
public class MainActivity extends Activity
{
    ...
    private void updateStandard()
    {
        ...
        if(number>0){
            tip15TextView.setText(currencyFormat.format(fifteenPercentTip/number));
            total15TextView.setText(currencyFormat.format(fifteenPercentTotal/number));
    ...
    private void updateCustom()
    {
        ...
        if(number>0){
            tipCustomTextView.setText(currencyFormat.format(customTip/number));
            totalCustomTextView.setText(currencyFormat.format(customTotal/number));
        }
        else{
