...
public class MainActivity extends Activity {
    ...
    private Integer number = 2; // number of members entered by the user
    ...
    private TextView numberDisplayTextView; // shows the number of party members
    ...
    private TextView avg15TextView; // shows average with 15% tip
    ...
    private TextView avgCustomTextView; // shows average with custom tip
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        avg15TextView = (TextView) findViewById(R.id.avg15TextView);
        ...
        numberDisplayTextView.setText(number.toString());
    ...
    private void updateStandard() {
        // calculate 15% tip and total and average
        double fifteenPercentTip = billAmount * 0.15;
        double fifteenPercentTotal = billAmount + fifteenPercentTip;
        double fifteenPercentAvg = fifteenPercentTotal / number;

        // display 15% tip and total and average formatted as currency
        tip15TextView.setText(currencyFormat.format(fifteenPercentTip));
        total15TextView.setText(currencyFormat.format(fifteenPercentTotal));
        avg15TextView.setText(currencyFormat.format(fifteenPercentAvg));
    ...
    private void updateCustom() {
        ...
        // calculate the custom tip and total and average
        double customTip = billAmount * customPercent;
        double customTotal = billAmount + customTip;
        double customAvg = customTotal / number;

        // display custom tip and total and average formatted as currency
        tipCustomTextView.setText(currencyFormat.format(customTip));
        totalCustomTextView.setText(currencyFormat.format(customTotal));
        avgCustomTextView.setText(currencyFormat.format(customAvg));
    ...
    private TextWatcher numberEditTextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start,
                                  int before, int count) {
            // convert numberEditText's text to a double
            try {
                number = Integer.parseInt(s.toString());
            } // end try
            catch (NumberFormatException e) {
                number = 2; // default if an exception occurs
            } // end catch
