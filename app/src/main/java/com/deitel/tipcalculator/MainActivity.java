...
public class MainActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        numberInP = (EditText)findViewById(R.id.numberOfp);
        numberInP.addTextChangedListener(amountEditTextWatcher2);
    ...
    private void updateStandard()
    {
        ...
        double fifteenPercentTotal = (billAmount + fifteenPercentTip) / numberOfp;
    ...
    private void updateCustom()
    {
        ...
        double customTotal = (billAmount + customTip)/numberOfp;
    ...
    private TextWatcher amountEditTextWatcher2 = new TextWatcher()
    {
                                  ...
                                  int before, int count)
        {
            ...
            try
            {
                numberOfp = Double.parseDouble(s.toString());
            } // end try
            catch (NumberFormatException e)
            {
                numberOfp = 0.0; // default if an exception occurs
            } // end catch
