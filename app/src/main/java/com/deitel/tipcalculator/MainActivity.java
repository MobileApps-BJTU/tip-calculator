...
public class MainActivity extends Activity {
    ...
    private TextView average15TextView; // shows average bill amount
    private TextView tip15TextView; // shows 15% tip
    private TextView averageCustomTextView; // shows custom tip amount
    private TextView tipCustomTextView; // shows custom tip
    private TextView partyNumDisplayTextView;   // shows the number in party
    private int numInParty = 1;// the number in party
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipCustomTextView =
                (TextView) findViewById(R.id.tipCustomTextView);
        partyNumDisplayTextView = (TextView) findViewById(R.id.partyNumDisplayTextView);
        ...
        // set partyNumEditText's TextWatcher
        EditText partyNumEditText =
                (EditText) findViewById(R.id.partyNumEditText);
        partyNumEditText.addTextChangedListener(partyNumEditTextWatcher);
    ...
    private void updateStandard() {
        ...
        double fifteenPerPerson = fifteenPercentTotal / numInParty;

        // display 15% total formatted as currency and total per person
        average15TextView.setText(currencyFormat.format(fifteenPerPerson));
    ...
    private void updateCustom() {
        ...
        double customPerPerson = customTotal / numInParty;

        // display custom tip and total formatted as currency
        averageCustomTextView.setText(currencyFormat.format(customPerPerson));
    ...
    // event-handling object that responds to partyNumEditText's events
    private TextWatcher partyNumEditTextWatcher = new TextWatcher() {
        // called when the user enters a number
        @Override
        public void onTextChanged(CharSequence s, int start,
                                  int before, int count) {
            // convert partyNumEditText's text to an integer
            try {
                numInParty = Integer.parseInt(s.toString());
                if (numInParty < 1) {
                    numInParty = 1;
                }
            } // end try
            catch (NumberFormatException e) {
                numInParty = 1; // default if an exception occurs
            } // end catch

            // display currency formatted person number in party
            partyNumDisplayTextView.setText(String.valueOf(numInParty));
            updateStandard(); // update the 15% tip TextViews
            updateCustom(); // update the custom tip TextViews
        } // end method onTextChanged
